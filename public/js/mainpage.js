angular.module('todo', ['ionic', 'ui.router'])
    .config(function($stateProvider, $urlRouterProvider) {

        $urlRouterProvider.when("", "/gongyigailan");

        $stateProvider
            .state("gongyigailan", {
                url: "/gongyigailan",
                templateUrl: "view/gongyigailan.html"
            })
            .state("gongyijianjie", {
                url: "/gongyijianjie",
                templateUrl: "view/gongyijianjie.html"
            })
            .state("gongyidazhong", {
                url: "/gongyidazhong",
                templateUrl: "view/gongyidazhong.html"
            })
            .state("qiyechangshang", {
                url: "/qiyechangshang",
                templateUrl: "view/qiyechangshang.html"
            })
            .state("shetuanzuzhi", {
                url: "/shetuanzuzhi",
                templateUrl: "view/shetuanzuzhi.html"
            })
            .state("zhuanjiajigou", {
                url: "/zhuanjiajigou",
                templateUrl: "view/zhuanjiajigou.html"
            })
            .state("gerenjieli", {
                url: "/gerenjieli",
                templateUrl: "view/gerenjieli.html"
            })
            .state("danweijieli", {
                url: "/danweijieli",
                templateUrl: "view/danweijieli.html"
            })
            .state("gongyishuoming", {
                url: "/gongyishuoming",
                templateUrl: "view/gongyishuoming.html"
            })
            .state("liangxinchangshang", {
                url: "/liangxinchangshang",
                templateUrl: "view/liangxinchangshang.html"
            })
            .state("zhuanyejigou", {
                url: "/zhuanyejigou",
                templateUrl: "view/zhuanyejigou.html"
            })
            .state("gongyizhengxun", {
                url: "/gongyizhengxun",
                templateUrl: "view/gongyizhengxun.html"
            })
            .state("gongyigou", {
                url: "/gongyigou",
                templateUrl: "view/gongyigou.html"
            });
    })
    /**
...
.controller('TodoCtrl', function($scope, $state, $ionicSideMenuDelegate) {
    ...
    /*
     * if given group is the selected group,
     *    deselect it
     * else
    ...
    $scope.toggleGroup = function(group) {
        ...
        if (group.name === "联创公益") {
            $state.go('gongyigailan');
        } else if (group.name === "公益概览") {
            $state.go('gongyigailan');
        } else if (group.name === "公益简介") {
            $state.go('gongyijianjie');
        } else if (group.name === "公益大众") {
            $state.go('gongyidazhong');
        } else if (group.name === "企业厂商") {
            $state.go('qiyechangshang');
        } else if (group.name === "社团组织") {
            $state.go('shetuanzuzhi');
        } else if (group.name === "专家机构") {
            $state.go('zhuanjiajigou');
        } else if (group.name === "个人接力") {
            $state.go('gerenjieli');
        } else if (group.name === "单位接力") {
            $state.go('danweijieli');
        } else if (group.name === "远离甲醛") {
            $state.go('gongyishuoming');
        } else if (group.name === "公益说明") {
            $state.go('gongyishuoming');
        } else if (group.name === "良心厂商") {
            $state.go('liangxinchangshang');
        } else if (group.name === "专业机构") {
            $state.go('zhuanyejigou');
        } else if (group.name === "公益征询") {
            $state.go('gongyizhengxun');
        } else if (group.name === "公益购") {
            $state.go('gongyigou');
        }
    };
    ...
    $scope.personEnroll = function() {
        $state.go('gerenjieli');
    };
    $scope.unitEnroll = function() {
        $state.go('danweijieli');
    };
